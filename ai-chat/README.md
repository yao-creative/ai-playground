...
- https://jxnl.co/writing/2024/02/28/levels-of-complexity-rag-applications/
...
There are three runnable entrypoints:

1. `01-chat-app-with-history.py`
   A minimal terminal chat app that keeps conversation history in the prompt.

2. `02-chat-app-with-stream.py`
   The same basic chat pattern, but with streamed output.
